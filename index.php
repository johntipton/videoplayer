<?PHP
// include the main query string params and Ooyala API 
include "locale.php";
?>
<!DOCTYPE html>
<html lang="en">
...
<?PHP
// ==================================================================
// Get info about this video - this would come directly from the CMS
// ==================================================================

// video 1
$embedCode1 = "cwazN4azruLD1i-8f7a9_KzubXaLkjFB";
// create the API method call
$method1 = "/v2/assets/" . $embedCode1;
// call the API and get results
$json1 = $api->sendRequest( "GET", $method1 );

print_r( $json1 );
?>
									<script src="http://player.ooyala.com/v3/<?PHP echo $json1->player_id?>?platform=html5-fallback&amp;namespace=dellvideoplayer" type="text/javascript"> </script>
                  ...
                  <script>
                      ...
                      var languageList = [];
                      var captionsUrl = "<?PHP echo $captionUrl ?>";
