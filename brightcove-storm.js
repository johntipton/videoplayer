...
$j(document).ready(function () {
  ...
  $j("video").each(function () {
    ...
    videojs(playerId).ready(function () {
      ...
      myPlayer.on("firstplay", trackVideoStart );
...
function timeupdateHandler(evt) {
  ...
  if (percPlayed > 79 && !eightyPercent ) 
  {
    eightyPercent = true;
...
function trackVideoStart( evt ) 
{
  ...
  evt.target.player.off( "firstplay", trackVideoStart );
}
// OMNITURE 80%
